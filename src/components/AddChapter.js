    ...
    <div className={classes.addchap}>
      ...
      <Paper elevation={3} style = {{width: '100%'}}>
        <Box p={1.5} className={classes.bluecolor}>
          ...
          <Paper elevation={2}>
          <TextField id="outlined-basic" placeholder='Enter Chapter Name' variant="outlined" style={{width:'100%'}}/>
          </Paper>          
            <br/>
          <Typography variant="h4" style={{ textAlign: 'left' , color:'white'}}>
            Chapter Data
          ...
          <Paper elevation={2}>
          <TextField id="outlined-multiline-static" multiline rows={10} placeholder="Enter Chapter's Content" style={{width:'100%'}}/>
          </Paper>          
